...
public class PayField07 implements VerifyMap {
    public static final int[] PORTAL_RGB = new int[] {1582,76, -6280000, -1200000};
    public static final int[] PORTAL_RGB_1 = new int[] {1466,103, -6280000, -1200000};
    Capture capture;
