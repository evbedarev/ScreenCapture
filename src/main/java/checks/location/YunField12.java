...
public class YunField12 implements VerifyMap {
    public static final int[] PORTAL_RGB = new int[] {1521,50, -6280000, -1200000};
    public static final int[] PORTAL_RGB_1 = new int[] {1466,96, -6280000, -1200000};
    Capture capture;
