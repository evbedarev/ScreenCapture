...
public class BeachDun02 implements VerifyMap {
    public static final int[] PORTAL_RGB = new int[] {1570,64, -6280000, -1200000};
    public static final int[] PORTAL_RGB_1 = new int[] {1526,164, -6280000, -1200000};
    Capture capture;
