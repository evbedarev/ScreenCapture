...
public class Sphinx03 implements VerifyMap {
    public static final int[] PORTAL_RGB = new int[] {1493,46, -6280000, -1200000};
    public static final int[] PORTAL_RGB_1 = new int[] {1572,139, -6280000, -1200000};
    Capture capture;
